export const filterData = [ {name:"PSO",image: require('../../assets/pso_logo.png'), id:"0"},
                            {name:"Shell",image:require("../../assets/Shell.png"),id:"1"},
                            {name:"Euro",image:require("../../assets/euro.jpg"),id:"2"},
                            {name:"Attack",image:require("../../assets/Attack.png"),id:"3"}
                          ];
...
export const stationsAround = [{latitude:28.491200,longitude:77.093440},// Plt # 22, B1-C MM Alam Rd, Block C 3 Gulberg III, Lahore, Punjab
    {latitude:34.201216,longitude:71.571592},//Haji Car Wash & Oil Change, Block N Gulberg 2, Lahore, Punjab
    {latitude:31.5310153,longitude:74.3590481},//Protek 3M car detailing, Protek Car Care, 38/a C/3, Block C3 Block C 3 Gulberg III, Lahore, Punjab 54000
    {latitude:31.5481063,longitude:74.3157746},//Jail Rd, Shadman 1 Shadman, Lahore, Punjab 54000
    {latitude:31.4888,longitude:74.3686},//24/2 Main Jail Rd، near Hyundai dealership, Jubilee Town, Lahore, Punjab 54000
]